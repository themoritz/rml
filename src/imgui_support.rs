// Taken from https://github.com/Gekkio/imgui-rs/blob/master/imgui-gfx-examples/examples/support/mod.rs
...
pub fn init(title: &str) -> System {
    ...
    let builder = glutin::WindowBuilder::new()
        ...
        .with_dimensions(glutin::dpi::LogicalSize::new(1280f64, 768f64));
